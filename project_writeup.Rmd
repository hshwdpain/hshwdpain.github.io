...
Then, we split training data into *preditors*( variables for predicting) and *outcomes*(classe). The testing data remains same. As the dim() shows, we obtain 19622¡Á53 predictors and 19622¡Á1 outcomes. Meanwhile, we have 20¡Á53 tempTest(testing data).
